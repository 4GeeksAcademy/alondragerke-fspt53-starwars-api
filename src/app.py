...
# POST favorites 
@app.route('/favorites/characters/<int:user_id>', methods=['POST'])
...
@app.route('/favorites/species/<int:user_id>', methods=['POST'])
def post_favorite_species(user_id):
    try:
        data = request.json
...
@app.route('/favorites/characters/<int:user_id>', methods=['DELETE'])
def delete_favorite_character(user_id):
    return delete_favorite(user_id, request.json.get('character_id'), 'character')

@app.route('/favorites/planets/<int:user_id>', methods=['DELETE'])
def delete_favorite_planet(user_id):
    return delete_favorite(user_id, request.json.get('planet_id'), 'planet')

@app.route('/favorites/species/<int:user_id>', methods=['DELETE'])
def delete_favorite_species(user_id):
    return delete_favorite(user_id, request.json.get('species_id'), 'species')

@app.route('/favorites/vehicles/<int:user_id>', methods=['DELETE'])
def delete_favorite_vehicle(user_id):
    return delete_favorite(user_id, request.json.get('vehicle_id'), 'vehicle')
