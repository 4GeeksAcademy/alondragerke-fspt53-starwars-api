...
Revision ID: dc6ea32f3ce1
Revises: a5cffa318ac2
Create Date: 2024-02-19 11:14:23.796134
...
def upgrade():
    ...
    with op.batch_alter_table('species', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_species_name'), ['name'], unique=False)
    ...
    sa.Column('max_atmostphering_speed', sa.Integer(), nullable=True),
